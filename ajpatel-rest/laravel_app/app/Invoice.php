...
class Invoice extends Model{
	...
	protected $invoice_sub_total="";
	protected $invoice_total_cgst="";
	protected $invoice_total_sgst="";
	protected $invoice_total_igst="";
	protected $invoice_rs_in_word="";
    ...
    public function set_invoice_sub_total($val){$this->invoice_sub_total=$val; }
    public function set_invoice_total_cgst($val){$this->invoice_total_cgst=$val; }
    public function set_invoice_total_sgst($val){$this->invoice_total_sgst=$val; }
    public function set_invoice_total_igst($val){$this->invoice_total_igst=$val; }
    public function set_invoice_rs_in_word($val){$this->invoice_rs_in_word=$val; }
    ...
    public function insert_invoice(){
		return DB::table($this->table)->insertGetId(
			[
				...
				'invoice_total_cgst' => $this->invoice_total_cgst,
				'invoice_total_sgst' => $this->invoice_total_sgst,
				'invoice_total_igst' => $this->invoice_total_igst,
				'invoice_rs_in_word' => $this->invoice_rs_in_word,
	...
	public function delete_by_invoice_id(){
		return DB::table($this->table)
			->where('invoice_id',$this->invoice_id)
			->delete();
	}
