...
class InvoiceItem extends Model{
    ...
    public function set_ii_amount($val){$this->ii_amount=$val; }
	...
	public function delete_item_by_invoice_id(){
		return DB::table($this->table)
			->where('ii_invoice_id',$this->ii_invoice_id)
			->delete();
	}
