...
Route::group(['prefix' => 'api'], function() {
	...
	Route::group(['middleware' => 'api_auth'], function() {
		...
		Route::post('party_delete', ['uses' => 'PartyController@party_delete']);
		...
		Route::post('product_delete', ['uses' => 'ProductController@product_delete']);
		...
		Route::post('invoice_delete',['uses'=>'InvoiceController@invoice_delete']);
